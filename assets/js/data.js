...
window.SITE_DATA = {
  ...
  experience: {
    work: {
      ...
      en: [{ period: "2015.03 – Present", text: "School of Software, Tsinghua University" }]
    },
    education: {
      zh: [
        { period: "2011.02 – 2014.12", text: "国防科技大学 计算机学院，博士" },
        { period: "2008.09 – 2010.12", text: "国防科技大学 计算机学院，硕士" },
        { period: "2004.09 – 2008.07", text: "南京航空航天大学 信息科学与技术学院，学士" }
      ],
      en: [
        { period: "2011.02 – 2014.12", text: "Ph.D., College of Computer, National University of Defense Technology" },
        { period: "2008.09 – 2010.12", text: "M.S., College of Computer, National University of Defense Technology" },
        { period: "2004.09 – 2008.07", text: "B.S., College of Information Science and Technology, Nanjing University of Aeronautics and Astronautics" }
      ]
    }
  },
  ...
  projects: [
    { zh: "三维几何建模引擎 GME（负责人）", en: "3D Geometric Modeling Engine GME (PI)", period: "2020 – Present" },
    { zh: "国家重点研发计划：自由曲线曲面设计与求交理论与方法（子课题负责人）", en: "NKRDP: Free-form curve and surface design and intersection (Sub-project PI)", period: "2021 – 2024" },
    { zh: "国家重点研发计划（“揭榜挂帅”）：三维 CAD 关键技术研究与工程应用（课题执行负责人）", en: "NKRDP (Tender): Key technologies for 3D CAD and engineering applications (Task Executive PI)", period: "2021 – 2025" },
    { zh: "国家重点研发计划（“揭榜挂帅”）：专用 CAD/CAE 软件研发与应用（参与）", en: "NKRDP (Tender): Dedicated CAD/CAE software R&D (Participant)", period: "2021 – 2025" },
    { zh: "国家重点研发计划（“揭榜挂帅”）：三维基础几何建模引擎（参与）", en: "NKRDP (Tender): Foundational 3D geometric modeling engine (Participant)", period: "2023 – 2026" },
    { zh: "信创海河实验室：面向船舶行业的三维几何造型引擎（课题负责人）", en: "Haihe Lab of ITAI: 3D modeling engine for shipbuilding (Task PI)", period: "2022 – 2024" },
    { zh: "清华大学（软件学院）— 云基智慧联合研究中心：三维几何内核（执行负责人）", en: "Tsinghua – Yunji Joint Research Center on 3D Geometric Kernel (Executive PI)", period: "2023 – 2026" },
    { zh: "工信部 工业软件内核研发及应用验证产业基础共性技术中心（课题执行负责人）", en: "MIIT Center for Industrial Software Kernel R&D and Verification (Task Executive PI)", period: "2023 – 2025" },
    { zh: "北京信息科学与技术国家研究中心：基础工业软件交叉创新群体（执行负责人）", en: "BNRist: Interdisciplinary Innovation Group on Foundational Industrial Software (Executive PI)", period: "2023 – 2026" },
    { zh: "工信部 航空工业软件关键模块内核（课题负责人）", en: "MIIT: Key module kernel for aviation industrial software (Task PI)", period: "2025 – 2027" }
  ],
  ...
  publications: [
    {
      ...
      links: [{ label: "DOI", href: "https://doi.org/10.1016/j.cad.2026.104081" }],
    ...
    {
      authors: "Shiyu Tan, Xiaolong Yin, Zhiheng Chen, Hao Gao, Zixuan Zhao, <b>Enya Shen*</b>",
    ...
    },
    {
      ...
      title: "Surface Offsetting: A Survey from Geometric Construction to Neural Implicit Representations",
      venue: "IEEE TVCG, PrePrints",
      links: [{ label: "DOI", href: "https://doi.org/10.1109/TVCG.2026.3676903" }],
    ...
    },
    {
      ...
      links: [{ label: "DOI", href: "https://doi.org/10.3724/SP.J.1089.2025-00141" }],
      teaser: "assets/img/teasers/3d-model-conversion.png"
    },
    {
      authors: "梁思立, 黄浩勉, 梁好, 唐为然, 鲍桉畅, <b>沈恩亚</b>, 王建民, 杨义军",
      title: "B-Rep 模型高效布尔运算算法",
      venue: "计算机辅助设计与图形学学报, 2025, 37(11): 1993-2005",
      links: [{ label: "DOI", href: "https://doi.org/10.3724/SP.J.1089.2024-00367" }],
    ...
    },
    {
      ...
      links: [{ label: "DOI", href: "https://doi.org/10.3724/SP.J.1089.2023.2023-00019" }],
    ...
    },
    {
      ...
      venue: "IEEE TVCG",
      links: [{ label: "DOI", href: "https://doi.org/10.1109/TVCG.2023.3238909" }],
      teaser: "assets/img/teasers/graph-exploration.png"
    },
    {
      authors: "Leixian Shen, <b>Enya Shen*</b>, Yuyu Luo, Xiaocong Yang, Xuming Hu, Xiongshuai Zhang, Zhiwei Tai, Jianmin Wang",
      title: "Towards Natural Language Interfaces for Data Visualization: A Survey",
      venue: "IEEE TVCG",
      links: [{ label: "DOI", href: "https://doi.org/10.1109/TVCG.2022.3148007" }],
    ...
    {
      authors: "<b>Enya Shen</b>, Jiazhi Xia, Zhiquan Cheng, R. Ralph Martin, Yunhai Wang, Sikun Li",
    ...
    {
      authors: "Hong Fan, Chufan Lai, Hanqi Guo, <b>Enya Shen</b>, Xiaoru Yuan, Sikun Li",
    ...
    },
    {
      ...
      venue: "1st International Conference on Computational Visual Media, 2012, Beijing",
      links: [],
    ...
    {
      authors: "<b>Enya Shen</b>, Huaxun Xu, Wenke Wang, Xun Cai, Liang Zeng, Sikun Li",
      title: "Interactive Visual Analysis of Vortex in 3D Flow with FFDL",
      venue: "International Conference on Virtual Reality and Visualization (ICVRV), 2011",
      links: [],
  ...
  patents: [
    { authors: "王建民, 沈恩亚, 沈磊贤, 太志伟", title: "一种基于样例的可视化生成方法及系统", id: "CN115098088A", date: "2022-09-23" },
    { authors: "毛贯中, 左光远, 王建民, 赵曦滨, 沈恩亚, 宋怡然", title: "债券产品的潜在客户推荐方法和装置", id: "CN113592529A", date: "2021-11-02" },
    { authors: "王建民, 沈恩亚, 太志伟, 宋怡然, 沈磊贤", title: "图布局优化方法和系统、电子设备及可读存储介质", id: "CN113127697A", date: "2021-07-16" },
    { authors: "王建民, 沈恩亚, 宋怡然, 沈磊贤", title: "一种自适应采样与查询方法及系统", id: "CN112883064A", date: "2021-06-01" },
    { authors: "王建民, 沈恩亚, 太志伟, 宋怡然", title: "一种社交网络关键节点发现方法及系统", id: "CN112765329A", date: "2021-05-07" },
    { authors: "王建民, 沈磊贤, 沈恩亚, 太志伟, 宋怡然", title: "一种面向任务的可视化推荐方法及装置", id: "CN112749224A", date: "2021-05-04" },
    { authors: "王建民, 沈恩亚, 张力, 钱舟", title: "一种多核心元素的知识图谱边图布局方法及系统", id: "CN111259165A", date: "2020-06-09" },
    { authors: "王建民, 沈恩亚, 张力, 韦宇华", title: "一种面向知识图谱的交互可视化方法、平台和系统", id: "CN111259297A", date: "2020-06-09" },
    { authors: "王建民, 沈恩亚, 刘英博, 赵鑫", title: "一种基于球面网格遥感数据文件集的键值存储方法及装置", id: "CN110263017A", date: "2019-09-20" },
    { authors: "曾亮, 徐华勋, 王怀晖, 蔡勋, 李思昆, 王文珂, 沈恩亚", title: "一种基于模糊测度的流场涡特征检测方法", id: "CN103440650A", date: "2013-12-11" },
    { authors: "王文珂, 王攀, 蔡勋, 李思昆, 曾亮, 沈恩亚, 王怀晖, 刘华海", title: "一种渐进最优的三角网格重复顶点快速去除方法", id: "CN103425787A", date: "2013-12-04" },
    { authors: "蔡勋, 马千里, 王文珂, 曾亮, 李思昆, 沈恩亚, 王攀, 王文涛", title: "基于双控制体的格心网格数据三维激波特征定位方法", id: "CN103413060A", date: "2013-11-27" },
    { authors: "李思昆, 王怀晖, 曾亮, 蔡勋, 王文珂, 徐华勋, 王攀, 沈恩亚", title: "基于旋转因子的曲面流场涡特征提取方法", id: "CN103413334A", date: "2013-11-27" },
    { authors: "李思昆, 沈恩亚, 蔡勋, 王文珂, 曾亮, 王攀, 王怀晖, 王文涛", title: "基于 GPU 的三维空间交互点判定加速方法", id: "CN103413345A", date: "2013-11-27" }
  ],
    ...
    alumni: {
      ...
      undergrad: {
        ...
        items: [
          ...
          { year: "2025", names: "葛宏泽、韩昊欣（清华大学）、赵一衡（山东大学）、吴政翰（四川大学）" }
        ]
      },
      intern: {
        label: { zh: "实习生", en: "Interns" },
        items: [
          { year: "2019/2020/2022", names: "岳魏琦（杭州电子科技大学）" },
